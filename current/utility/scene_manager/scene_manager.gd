...
var _loading_screen_scene:PackedScene = preload("res://menus/loading_screen/loading_screen.tscn")
...
var dialogue_node = preload("res://utility/text/dialogue_panel/dialogue_panel.tscn")
var hit_indicator_node = preload("res://utility/text/hit_indicator/hit_indicator.tscn")
