...
func Enter():
	...
	#direction_of_hit = character_body.global_position.direction_to(player.global_position  + Vector2(0.0, 23.0))
	direction_of_hit = Vector2(-1.0, 0.0) # TODO: Calculate proper direction_of_hit
	character_body.velocity = direction_of_hit * 200.0
